                        ...
                        <div class="mt-4 space-y-2">
                            ...
                            <ul class="space-y-1.5">
                                <li class="flex items-start text-sm text-muted-foreground">
                                    <svg class="w-4 h-4 text-green-500 mt-0.5 mr-2 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-12 overflow-x-auto">
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-muted">
                        <th class="p-4 font-bold text-foreground rounded-tl-xl">Kriteria</th>
                        <th class="p-4 font-bold text-primary">Zonasi</th>
                        <th class="p-4 font-bold text-green-600 dark:text-green-400">Afirmasi</th>
                        <th class="p-4 font-bold text-purple-600 dark:text-purple-400">Perpindahan</th>
                        <th class="p-4 font-bold text-amber-600 dark:text-amber-400 rounded-tr-xl">Prestasi</th>
                    </tr>
                </thead>
