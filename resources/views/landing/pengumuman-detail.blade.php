...
<section class="relative pt-32 pb-16 lg:pt-40 lg:pb-20 bg-gradient-to-br from-primary via-primary/80 to-primary/60 overflow-hidden">
    ...
    <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <a href="{{ route('landing.pengumuman') }}" class="inline-flex items-center text-primary-foreground/80 hover:text-primary-foreground transition-colors mb-6">
            <svg aria-hidden="true"   class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
            ...
            <div class="lg:col-span-2">
                ...
                <div class="mt-10 flex items-center justify-between py-6 border-t border-b border-border">
                    <div class="flex items-center gap-3">
                        ...
                        <a href="#" class="w-8 h-8 rounded-lg bg-muted flex items-center justify-center text-muted-foreground hover:bg-primary hover:text-primary-foreground transition-colors" aria-label="Bagikan ke Facebook">
                        ...
                        <a href="#" class="w-8 h-8 rounded-lg bg-muted flex items-center justify-center text-muted-foreground hover:bg-primary hover:text-primary-foreground transition-colors" aria-label="Bagikan ke Twitter">
                        ...
                        <a href="#" class="w-8 h-8 rounded-lg bg-muted flex items-center justify-center text-muted-foreground hover:bg-primary hover:text-primary-foreground transition-colors" aria-label="Bagikan ke LinkedIn">
