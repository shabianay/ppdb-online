...
<div>
    <form wire:submit="register" class="space-y-4">
        ...
        <div>
            ...
            <x-text-input wire:model="no_hp" id="no_hp" class="block mt-1 w-full" type="text" name="no_hp" placeholder="08xxxxxxxxxx" />
            <x-input-error :messages="$errors->get('no_hp')" class="mt-2" />
        </div>

        <div>
            <x-input-label for="nik" :value="__('NIK (Nomor Induk Kependudukan)')" />
            <x-text-input wire:model="nik" id="nik" class="block mt-1 w-full" type="text" name="nik" maxlength="16" placeholder="16 digit NIK" />
