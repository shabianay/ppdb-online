    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('pendaftaran.pdf', $pendaftar) }}" target="_blank" class="px-4 py-2 bg-muted text-foreground font-semibold rounded-xl hover:bg-accent transition-all text-sm border border-border flex items-center gap-2">
